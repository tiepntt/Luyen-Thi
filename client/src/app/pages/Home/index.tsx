      ...
      <div className="content-home-page">
        ...
        <Container style={{ padding: 100 }}>
          <Row>
            <Col lg={6}>
              <Image
                style={{ maxWidth: 400 }}
                src="https://ik.imagekit.io/tqk8izesmc8/Luyenthi/images/home/boy_ltpro_2_0h0TexZav2p.png?updatedAt=1639423572274"
                fluid={true}
              />
            </Col>
            <Col lg={6} className="d-flex align-items-center">
              <div>
                ...
                <br />
                <Button className="start-button" href="/practice">
                  Bắt đầu ngay
                </Button>
              </div>
            </Col>
              ...
              <Col lg={4} md={12} sm={12} className="mb-5">
                <Row>
                  <Col lg={12} md={6}>
                    <Image
                      src={
                        "https://ik.imagekit.io/tqk8izesmc8/Luyenthi/images/home/image_67B7THlN6.svg?updatedAt=1639424885952"
                      }
                      fluid={true}
                    />
                  </Col>
                  <Col lg={12} md={6} className="mb-5">
                    ...
                    <br />
                    <span>
                      Học sinh có thể ôn luyện mọi lúc, mọi nơi. Các phân tích
                      báo cáo về chế độ luyện tập cá nhân sẽ giúp học sinh được
                      phần đang yếu.
                    </span>
                  </Col>
                </Row>
                ...
                <Row>
                  <Col lg={12} md={6}>
                    <Image
                      style={{ minWidth: 148 }}
                      src={
                        "https://ik.imagekit.io/tqk8izesmc8/Luyenthi/images/home/image2_j3-98XIGBTR.svg?updatedAt=1639424886220"
                      }
                      fluid={true}
                    />
                  </Col>
                  <Col lg={12} md={6}>
                    ...
                    <br />
                    <span>
                      Các câu hỏi và đề thi bám sát chương trình học, cung cấp
                      một nền tảng luyện tập tốt nhất cho học sinh, giúp học
              ...
              <Col lg={4} md={12} sm={12}>
                <Row>
                  ...
                  <Col lg={12} md={6}>
                    ...
                    <br />
                    <span>
                      Phân tích ma trận đề thi phù hợp với từng khối lớp, giúp
                      giáo viên tạo được đề thi dễ dàng và chất lượng.
                    </span>
                  </Col>
                </Row>
              </Col>
        ...
        <Row className="document-section">
          <Col className="document-list left align-items-end">
            <div>TOÁN</div>
            <div className="position-relative" style={{ right: "32px" }}>
              VĂN
            </div>
            <div>VẬT LÝ</div>
          </Col>
          ...
          <Col className="document-list right">
            <div>HÓA HỌC</div>
            <div className="position-relative" style={{ left: "32px" }}>
              SINH HỌC
            </div>
            <div>TIẾNG ANH</div>
          </Col>
        ...
        <div className="test-section text-center d-flex flex-column justify-content-between align-items-center">
          ...
          <div className="list-class">
            ...
            <div className="d-flex">
              ...
              <div className="national-test">
                Ôn thi THPT quốc gia<hr></hr>
              </div>
            </div>
          </div>
          <h5 className="mb-5">
            Bộ Đề Thi - Phân chia theo lớp phù hợp với tất cả đối tượng học sinh
          </h5>
        </div>
      </div>
    </div>
